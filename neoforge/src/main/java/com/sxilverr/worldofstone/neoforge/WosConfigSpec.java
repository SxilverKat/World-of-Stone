...
public final class WosConfigSpec {
    ...
    public static final ModConfigSpec.BooleanValue STONE_REPLACEMENT_ENABLED;
    public static final ModConfigSpec.EnumValue<WorldgenSystem> WORLDGEN_SYSTEM;

    public static final ModConfigSpec.BooleanValue REPLACE_STONE_ABOVE_GROUND;
    public static final ModConfigSpec.BooleanValue REPLACE_SAND;
    public static final ModConfigSpec.BooleanValue REPLACE_SANDSTONE;
    public static final ModConfigSpec.BooleanValue REPLACE_GRAVEL;
    public static final ModConfigSpec.BooleanValue REPLACE_CLAY;
    public static final ModConfigSpec.BooleanValue REPLACE_RED_SAND_AND_SANDSTONE;
    public static final ModConfigSpec.IntValue VARIANT_CHANCE;
    public static final ModConfigSpec.DoubleValue STRATA_BOTTOM_RATIO;
    public static final ModConfigSpec.DoubleValue STRATA_MIDDLE_RATIO;
    public static final ModConfigSpec.BooleanValue IGNORE_STRATA_HEIGHT_RESTRICTIONS;
    public static final ModConfigSpec.BooleanValue ALLOW_STRATA_IN_DEEPSLATE;
    public static final ModConfigSpec.BooleanValue ALLOW_VANILLA_ORES_IN_NETHER;
    public static final ModConfigSpec.BooleanValue ALLOW_VANILLA_ORES_IN_END;
    public static final ModConfigSpec.BooleanValue ALLOW_OBSIDIAN_ORE_VARIANTS;
    public static final ModConfigSpec.DoubleValue NETHER_ORE_ATTEMPTS_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue END_ORE_ATTEMPTS_MULTIPLIER;
    public static final ModConfigSpec.BooleanValue ALLOW_OVERGROWN_STRATA;
    public static final ModConfigSpec.BooleanValue ALLOW_SNOWED_STRATA;
    public static final ModConfigSpec.BooleanValue ALLOW_OVERGROWN_VANILLA_VARIANTS;
    public static final ModConfigSpec.BooleanValue ALLOW_SNOWED_VANILLA_VARIANTS;

    public static final ModConfigSpec.IntValue PATCH_SIZE;
    public static final ModConfigSpec.BooleanValue REPLACE_VANILLA_ORES;
    public static final ModConfigSpec.BooleanValue ENABLE_STRUCTURE_VARIANT_GENERATION;
    public static final ModConfigSpec.IntValue STRATA_XZ_DITHER;
    public static final ModConfigSpec.IntValue STRATA_Y_DITHER;

    public static final ModConfigSpec.IntValue BLOBS_PER_CHUNK;
    public static final ModConfigSpec.IntValue BLOB_SIZE;

    public static final ModConfigSpec.IntValue NOISE_SCALE;
    public static final ModConfigSpec.EnumValue<NoiseType> NOISE_TYPE;
    public static final ModConfigSpec.IntValue NOISE_OCTAVES;

    public static final ModConfigSpec.BooleanValue SPELEOTHEMS_ENABLED;
    public static final ModConfigSpec.BooleanValue SPELEOTHEMS_GENERATE;
    public static final ModConfigSpec.BooleanValue SANDSTONE_SPELEOTHEMS_ENABLED;
    public static final ModConfigSpec.IntValue SPELEOTHEM_RARITY;
    public static final ModConfigSpec.IntValue SPELEOTHEM_ATTEMPTS_PER_CHUNK;
    public static final ModConfigSpec.BooleanValue SPELEOTHEMS_WATERLOGGABLE;
    public static final ModConfigSpec.BooleanValue SPELEOTHEMS_GENERATE_IN_WATER;
    public static final ModConfigSpec.BooleanValue SPELEOTHEMS_GENERATE_IN_LAVA;
    public static final ModConfigSpec.BooleanValue SPELEOTHEMS_BREAK_BY_WATER;
    public static final ModConfigSpec.BooleanValue SPELEOTHEMS_BREAK_BY_LAVA;
    public static final ModConfigSpec.BooleanValue SPELEOTHEMS_DROP_WITHOUT_SILK_TOUCH;
    public static final ModConfigSpec.BooleanValue SPELEOTHEMS_DRIPSTONE_DAMAGE;
    public static final ModConfigSpec.BooleanValue SPELEOTHEMS_CAN_FALL;
    public static final ModConfigSpec.BooleanValue SPELEOTHEMS_DROP_ON_FALL;
    public static final ModConfigSpec.BooleanValue SPELEOTHEMS_ALLOW_SKY_VIEW;
    public static final ModConfigSpec.BooleanValue SPELEOTHEMS_ALLOW_SKY_VIEW_END;
    public static final ModConfigSpec.BooleanValue SPELEOTHEMS_ALLOW_ABOVE_GROUND;
    public static final ModConfigSpec.BooleanValue SPELEOTHEMS_ALLOW_POINTING_UP_ABOVE_GROUND;
    public static final ModConfigSpec.BooleanValue FOSSILS_ENABLED;
    public static final ModConfigSpec.DoubleValue FOSSIL_DROP_CHANCE;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> FOSSIL_DROP_BLOCKS;
    public static final ModConfigSpec.BooleanValue MASON_TRADES_ENABLED;
    public static final ModConfigSpec.BooleanValue ALLOW_PILLAR_VARIANT_TRADES;
    public static final ModConfigSpec.BooleanValue STONE_DROPS_COBBLESTONE;
    public static final ModConfigSpec.BooleanValue LIGNITE_DROPS_LIGNITE_COBBLESTONE;
    public static final ModConfigSpec.BooleanValue ENABLE_INFESTED_BLOCKS;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> MIMIC_SPELEOTHEM_BLOCKS;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> MIMIC_SPELEOTHEM_WORLDGEN_BLOCKS;

    public static final Map<IgneousVariant, ModConfigSpec.BooleanValue> IGNEOUS_VARIANT_ENABLED = new EnumMap<>(IgneousVariant.class);
    public static final Map<MetamorphicVariant, ModConfigSpec.BooleanValue> METAMORPHIC_VARIANT_ENABLED = new EnumMap<>(MetamorphicVariant.class);
    public static final Map<SedimentaryVariant, ModConfigSpec.BooleanValue> SEDIMENTARY_VARIANT_ENABLED = new EnumMap<>(SedimentaryVariant.class);

    public static final Map<IgneousVariant, ModConfigSpec.IntValue> IGNEOUS_VARIANT_WEIGHT = new EnumMap<>(IgneousVariant.class);
    public static final Map<MetamorphicVariant, ModConfigSpec.IntValue> METAMORPHIC_VARIANT_WEIGHT = new EnumMap<>(MetamorphicVariant.class);
    public static final Map<SedimentaryVariant, ModConfigSpec.IntValue> SEDIMENTARY_VARIANT_WEIGHT = new EnumMap<>(SedimentaryVariant.class);

    public static final Map<IgneousVariant, ModConfigSpec.BooleanValue> IGNEOUS_SPELEOTHEM = new EnumMap<>(IgneousVariant.class);
    public static final Map<MetamorphicVariant, ModConfigSpec.BooleanValue> METAMORPHIC_SPELEOTHEM = new EnumMap<>(MetamorphicVariant.class);
    public static final Map<SedimentaryVariant, ModConfigSpec.BooleanValue> SEDIMENTARY_SPELEOTHEM = new EnumMap<>(SedimentaryVariant.class);
    public static final Map<IgneousVariant, ModConfigSpec.BooleanValue> IGNEOUS_SANDSTONE_SPELEOTHEM = new EnumMap<>(IgneousVariant.class);
    public static final Map<MetamorphicVariant, ModConfigSpec.BooleanValue> METAMORPHIC_SANDSTONE_SPELEOTHEM = new EnumMap<>(MetamorphicVariant.class);
    public static final Map<SedimentaryVariant, ModConfigSpec.BooleanValue> SEDIMENTARY_SANDSTONE_SPELEOTHEM = new EnumMap<>(SedimentaryVariant.class);
    public static final Map<VanillaSpeleothemVariant, ModConfigSpec.BooleanValue> VANILLA_SPELEOTHEM = new EnumMap<>(VanillaSpeleothemVariant.class);
    public static final Map<QuarkSpeleothemVariant, ModConfigSpec.BooleanValue> QUARK_SPELEOTHEM = new EnumMap<>(QuarkSpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.UndergardenSpeleothemVariant, ModConfigSpec.BooleanValue> UNDERGARDEN_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.UndergardenSpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.CreateSpeleothemVariant, ModConfigSpec.BooleanValue> CREATE_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.CreateSpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.BetterEndSpeleothemVariant, ModConfigSpec.BooleanValue> BETTEREND_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.BetterEndSpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.GalosphereSpeleothemVariant, ModConfigSpec.BooleanValue> GALOSPHERE_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.GalosphereSpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.BwgSpeleothemVariant, ModConfigSpec.BooleanValue> BWG_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.BwgSpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.TwilightForestSpeleothemVariant, ModConfigSpec.BooleanValue> TWILIGHTFOREST_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.TwilightForestSpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.AetherSpeleothemVariant, ModConfigSpec.BooleanValue> AETHER_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.AetherSpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.BlueSkiesSpeleothemVariant, ModConfigSpec.BooleanValue> BLUE_SKIES_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.BlueSkiesSpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.SpelunkerySpeleothemVariant, ModConfigSpec.BooleanValue> SPELUNKERY_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.SpelunkerySpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.IceAndFireSpeleothemVariant, ModConfigSpec.BooleanValue> ICEANDFIRE_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.IceAndFireSpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.MysticalAgricultureSpeleothemVariant, ModConfigSpec.BooleanValue> MYSTICALAGRICULTURE_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.MysticalAgricultureSpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.BiomesOPlentySpeleothemVariant, ModConfigSpec.BooleanValue> BIOMESOPLENTY_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.BiomesOPlentySpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.ForbiddenArcanusSpeleothemVariant, ModConfigSpec.BooleanValue> FORBIDDEN_ARCANUS_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.ForbiddenArcanusSpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.AlexsCavesSpeleothemVariant, ModConfigSpec.BooleanValue> ALEXSCAVES_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.AlexsCavesSpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.ArsNouveauSpeleothemVariant, ModConfigSpec.BooleanValue> ARS_NOUVEAU_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.ArsNouveauSpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.CataclysmSpeleothemVariant, ModConfigSpec.BooleanValue> CATACLYSM_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.CataclysmSpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.TwigsSpeleothemVariant, ModConfigSpec.BooleanValue> TWIGS_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.TwigsSpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.ArchitectsPaletteSpeleothemVariant, ModConfigSpec.BooleanValue> ARCHITECTS_PALETTE_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.ArchitectsPaletteSpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.OuterEndSpeleothemVariant, ModConfigSpec.BooleanValue> OUTER_END_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.OuterEndSpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.BotaniaSpeleothemVariant, ModConfigSpec.BooleanValue> BOTANIA_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.BotaniaSpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.AdAstraSpeleothemVariant, ModConfigSpec.BooleanValue> AD_ASTRA_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.AdAstraSpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.DeepAetherSpeleothemVariant, ModConfigSpec.BooleanValue> DEEP_AETHER_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.DeepAetherSpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.CavernsAndChasmsSpeleothemVariant, ModConfigSpec.BooleanValue> CAVERNS_AND_CHASMS_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.CavernsAndChasmsSpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.AtmosphericSpeleothemVariant, ModConfigSpec.BooleanValue> ATMOSPHERIC_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.AtmosphericSpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.EndergeticSpeleothemVariant, ModConfigSpec.BooleanValue> ENDERGETIC_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.EndergeticSpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.WilderWildsSpeleothemVariant, ModConfigSpec.BooleanValue> WILDER_WILDS_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.WilderWildsSpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.RegionsUnexploredSpeleothemVariant, ModConfigSpec.BooleanValue> REGIONS_UNEXPLORED_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.RegionsUnexploredSpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.BornInChaosSpeleothemVariant, ModConfigSpec.BooleanValue> BORN_IN_CHAOS_V1_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.BornInChaosSpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.NaturalistSpeleothemVariant, ModConfigSpec.BooleanValue> NATURALIST_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.NaturalistSpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.YungsCaveBiomesSpeleothemVariant, ModConfigSpec.BooleanValue> YUNGSCAVEBIOMES_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.YungsCaveBiomesSpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.NaturesSpiritSpeleothemVariant, ModConfigSpec.BooleanValue> NATURES_SPIRIT_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.NaturesSpiritSpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.NetherExpSpeleothemVariant, ModConfigSpec.BooleanValue> NETHEREXP_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.NetherExpSpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.DeeperDarkerSpeleothemVariant, ModConfigSpec.BooleanValue> DEEPERDARKER_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.DeeperDarkerSpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.TheDeepVoidSpeleothemVariant, ModConfigSpec.BooleanValue> THE_DEEP_VOID_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.TheDeepVoidSpeleothemVariant.class);
    public static final Map<com.sxilverr.worldofstone.api.enums.DefiledLandsSpeleothemVariant, ModConfigSpec.BooleanValue> DEFILED_LANDS_PREBORN_SPELEOTHEM = new EnumMap<>(com.sxilverr.worldofstone.api.enums.DefiledLandsSpeleothemVariant.class);
    public static final Map<TerracottaSpeleothemVariant, ModConfigSpec.BooleanValue> TERRACOTTA_SPELEOTHEM_ENABLED_MAP = new EnumMap<>(TerracottaSpeleothemVariant.class);
    public static final Map<VanillaOreHost, ModConfigSpec.BooleanValue> VANILLA_ORE_HOST_ENABLED = new EnumMap<>(VanillaOreHost.class);
    public static final ModConfigSpec.BooleanValue TERRACOTTA_SPELEOTHEMS_ENABLED;
    public static final ModConfigSpec.BooleanValue ICE_SPELEOTHEM_ENABLED;
    public static final ModConfigSpec.BooleanValue CREATIVE_SPELEOTHEMS_ENABLED;
    ...
    private static <K extends Enum<K>> void bakeBoolMap(Map<K, ModConfigSpec.BooleanValue> spec, Map<K, Boolean> baked) {
        baked.clear();
        for (Map.Entry<K, ModConfigSpec.BooleanValue> e : spec.entrySet()) {
            baked.put(e.getKey(), e.getValue().get());
        }
    }

    private static <K extends Enum<K>> void bakeIntMap(Map<K, ModConfigSpec.IntValue> spec, Map<K, Integer> baked) {
        baked.clear();
        for (Map.Entry<K, ModConfigSpec.IntValue> e : spec.entrySet()) {
            baked.put(e.getKey(), e.getValue().get());
        }
    }
