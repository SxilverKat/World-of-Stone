...
SRC_TEX = os.path.join(os.path.dirname(os.path.abspath(__file__)), "src", "main", "resources", "assets", "worldofstone", "textures", "block")
SRC_OVERLAY_DIR = os.path.join(SRC_TEX, "overlays", "overgrown")
SRC_ITEM_TEX = os.path.join(os.path.dirname(os.path.abspath(__file__)), "src", "main", "resources", "assets", "worldofstone", "textures", "item")
...
DST_ASSETS = os.path.join(ROOT, "src", "main", "resources", "assets", "worldofstone")
DST_DATA = os.path.join(ROOT, "src", "main", "resources", "data", "worldofstone")
DST_MC_TAGS = os.path.join(ROOT, "src", "main", "resources", "data", "minecraft", "tags", "blocks")
DST_MC_ITEM_TAGS = os.path.join(ROOT, "src", "main", "resources", "data", "minecraft", "tags", "items")
DST_FORGE_TAGS = os.path.join(ROOT, "src", "main", "resources", "data", "forge", "tags", "blocks")
DST_FORGE_ITEM_TAGS = os.path.join(ROOT, "src", "main", "resources", "data", "forge", "tags", "items")
...
def write_infested_block(name, host_name, host_display):
...
DECORATIVE_SPELEOTHEMS = [
    ...
    ("sponge_speleothem", "minecraft:block/sponge", "Sponge Speleothem", False, None, None),
    ...
    ("moss_speleothem", "minecraft:block/moss_block", "Moss Speleothem", False, None, None),
    ...
    ("hay_bale_speleothem", "minecraft:block/hay_block_side", "Hay Bale Speleothem", False, None, None),
    ("sculk_speleothem", "minecraft:block/sculk", "Sculk Speleothem", False, None, None),
    ("sculk_catalyst_speleothem", "minecraft:block/sculk_catalyst_side", "Sculk Catalyst Speleothem", False, None, None),
    ("clay_speleothem", "minecraft:block/clay", "Clay Speleothem", False, None, None),
    ("podzol_speleothem", "minecraft:block/podzol_side", "Podzol Speleothem", False, None, None),
    ("mycelium_speleothem", "minecraft:block/mycelium_side", "Mycelium Speleothem", False, None, None),
    ("coarse_dirt_speleothem", "minecraft:block/coarse_dirt", "Coarse Dirt Speleothem", False, None, None),
    ("rooted_dirt_speleothem", "minecraft:block/rooted_dirt", "Rooted Dirt Speleothem", False, None, None),
    ("soul_sand_speleothem", "minecraft:block/soul_sand", "Soul Sand Speleothem", False, None, None),
    ("soul_soil_speleothem", "minecraft:block/soul_soil", "Soul Soil Speleothem", False, None, None),
    ("grass_speleothem", "minecraft:block/grass_block_side", "Grass Speleothem", False, None, None),
    ("brown_mushroom_speleothem", "minecraft:block/brown_mushroom_block", "Brown Mushroom Speleothem", False, None, None),
    ("red_mushroom_speleothem", "minecraft:block/red_mushroom_block", "Red Mushroom Speleothem", False, None, None),
    ("nether_wart_speleothem", "minecraft:block/nether_wart_block", "Nether Wart Speleothem", False, None, None),
    ("warped_wart_speleothem", "minecraft:block/warped_wart_block", "Warped Wart Speleothem", False, None, None),
    ("shroomlight_speleothem", "minecraft:block/shroomlight", "Shroomlight Speleothem", False, None, None),
    ...
    ("melon_speleothem", "minecraft:block/melon_side", "Melon Speleothem", False, None, None),
    ("pumpkin_speleothem", "minecraft:block/pumpkin_side", "Pumpkin Speleothem", False, None, None),
    ("warped_nylium_speleothem", "minecraft:block/warped_nylium_side", "Warped Nylium Speleothem", False, None, None),
    ("crimson_nylium_speleothem", "minecraft:block/crimson_nylium_side", "Crimson Nylium Speleothem", False, None, None),
    ...
    ("bamboo_mosaic_speleothem", "minecraft:block/bamboo_mosaic", "Bamboo Mosaic Speleothem", False, None, None),
...
def main():
    ...
    for variant in IGNEOUS + METAMORPHIC + SEDIMENTARY:
        ...
        write_infested_block(f"infested_{variant}_cobblestone", f"{variant}_cobblestone", lang_for(f"{variant}_cobblestone"))
    ...
    brick_ids = [f"worldofstone:{v}_bricks" for v in IGNEOUS + METAMORPHIC]
    brick_ids += [f"worldofstone:mossy_{v}_bricks" for v in IGNEOUS + METAMORPHIC]
    all_ore_ids = []
    ...
    sand_tints_dir = os.path.join(ROOT, "src", "main", "resources", "data", "worldofstone")
